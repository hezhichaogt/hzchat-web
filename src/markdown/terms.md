...
By accessing or using the HZ Chat service in any way, you acknowledge that you have read, understood, and agree to be bound by all the terms of this Agreement. If you do not agree to any part of this Agreement, please cease using the service immediately.

### 1.2 Minor Disclaimer

This service is not designed for minors. Users who have not reached the age of legal majority in their jurisdiction (minors) should use this service only under the supervision and guidance of a legal guardian. You understand and agree that HZ Chat is not responsible for any consequences arising from a minor's use of the service.

## 2. User Conduct and Content Responsibility
...
You commit that, when using the service, you will not send, transmit, or share any content that violates applicable laws and regulations, including but not limited to:

1.  Any content that is unlawful, obscene, pornographic, threatening, or defamatory.
2.  Content that promotes violence, hate speech, or discrimination against any group.
...
## 3. Business Model and Disclaimer

### 3.1 Business Model Commitment

To maintain the service's integrity and protect user privacy, we commit that **HZ Chat neither integrates nor plans to integrate any advertising services.** We may, in the future, generate revenue through voluntary **subscription services** or other non-advertising forms.

### 3.2 Service Provided "As Is"

**The HZ Chat service is provided "as is" and "as available," without warranties of any kind, whether express or implied.** We do not guarantee the availability, reliability, or that the service will be free from interruptions or errors.

### 3.3 Limitation of Liability

To the maximum extent permitted by applicable law, HZ Chat shall not be liable for any direct, indirect, special, or punitive damages you incur from the use or inability to use this service.

## 4. Governing Law and Contact

### 4.1 Governing Law and Dispute Resolution

The validity, interpretation, performance, and resolution of disputes arising from this Agreement shall be governed by the laws of the **Republic of Singapore**. Any dispute arising from this Agreement shall first be resolved through friendly negotiation. If a resolution cannot be reached, either party may submit the dispute to an arbitration institution in Singapore, and it shall be resolved in accordance with that institution's rules.

### 4.2 Agreement Updates

We may revise this Agreement periodically. The updated version will be posted on this page.

### 4.3 Contact Us

If you have any questions regarding this Agreement, please contact us via email: **privacy@hzclog.com**.
